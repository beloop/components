...
namespace Beloop\Bundle\CoreBundle\Test\Functional;
...
abstract class WebTestCase extends PHPUnit_Framework_TestCase
{
    ...
    {
        $namespaceExploded = explode('\\Test\\Functional\\', get_called_class(), 2);
        $kernelClass = $namespaceExploded[0] . '\\Test\\Functional\\app\\AppKernel';
    ...
    protected static function createKernel()
    {
        ...
        $namespaceExploded = explode('\\Test\\Functional\\', get_called_class(), 2);
        $bundleName = explode('Beloop\\', $namespaceExploded[0], 2)[1];
